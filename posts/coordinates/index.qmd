---
title: "Coordinate transformations with Julia"
...
This post is about geodetic coordinate transformations using `Julia`.
...
How can I transform coordinates given as "`latitude, longitude`" into some other coordinate system, e.g., UTM?
:::
