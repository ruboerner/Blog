...
The `pyGIMLi` is a Python library. We assume that a Python environment is already installed. The easiest option is [*miniconda*](https://www.anaconda.com/docs/getting-started/miniconda/main).
